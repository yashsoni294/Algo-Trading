...
# df['time'] = pd.to_datetime(df['time'], unit='s')
# print("✅ Data loaded:", len(df), "candles")

# df['ema21'] = ema(df['close'], 21)
# df['ema51'] = ema(df['close'], 51)
...
#     # -------- SIGNAL --------
#     bullish = (
#         prev.ema21 <= prev.ema51 and
#         curr.ema21 > curr.ema51 and
#         # curr.rsi >= 60 and
#         curr.ema21 > curr.ema200
#     )
...
#     if bullish:
#         sl = curr.ema21 - 2 * atr_val
#         tp = entry + (REWARD_PER_TRADE / RISK_PER_TRADE) * (entry - sl)
#         direction = "BUY"
#     else:
#         sl = curr.ema21 + 2 * atr_val
#         tp = entry - (REWARD_PER_TRADE / RISK_PER_TRADE) * (sl - entry)
#         direction = "SELL"
...
# print(f"Start Balance : ${INITIAL_BALANCE}")
